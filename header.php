<?php
session_start();
include("loginpage/includes/application.php");
?>
				...
				<div class="container">
                    <div class="row">
                        <div class="span3">
                            ...
                            <div id="logo">
                                <a href="index.php">
                              <!--  <h1 style="font-size:45px; padding-top:0.8em; color:#f49521;">Job<span style="color:#003399;">Sketch</span></h1>-->
                                    <img src="assets/images/logo.jpg" alt="website logo"  style="vertical-align:bottom;padding:0em; width:65px;">
                                </a>
                            </div>
                            ...
                            <nav>
                                <ul class="sf-menu " id="menu">
                                    <li>
                                     ...
                                     <!-- <ul>
                                        	<li><a href="services.php">Permanent & Flexi Staffing</a></li>
                                            <li><a href="services.php">Why Jobsketch</a></li>
                                        </ul>-->
                                      
                                      </li>	
                                    <!--  <li ><a href="gallery.php"><span>Gallery</span></a>	</li>-->
                                    <?php if(isset($_SESSION['_SESS_USERID'])){ ?>
                                       <li ><a href="openings.php"><span>Openings</span></a>	</li>	
                                      <?php } ?>
                                  ...
                                  <li ><?php if(!isset($_SESSION['_SESS_USERID'])) { ?><a href="jobseeker-login.php"><span>Jobseeker Login</span></a> <li ><a href="employer-login.php"><span>Employer Login</span></a><?php } else { ?><a href="#"><span><?php echo $_SESSION['_SESS_USERNAME']; ?></span></a>&nbsp;<li style="marign-right:9px; margin-top:9px; padding-left:4px;"><a href="logout.php">&nbsp;Logout</a> </li><?php } ?></li>
