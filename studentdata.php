...
$searchqry = mysqli_query($con,"select * from  uploadjobskrdata_t where jobsekrStatus = 'E' order by jobsekr_id DESC ");
...
<td>
 ...
 <?php  
	...
	$searchqry1 	   = mysqli_query($con,"select uploadImgPath
							
										from upload_t
							 			where user_id = '".$searchfetch['user_id']."'");
	while($searchfetch1 	 = mysqli_fetch_array($searchqry1)){
