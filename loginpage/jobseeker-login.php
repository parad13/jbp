...
<?php include("includes/head_links.php") ?>
	...
	<div class="container">
		<div class="full-content-center">
			...
			<h2><a href="index">Job Seeker Login</a></h2>
			...
			<div class="login-wrap animated flipInX">
				<div class="login-block">
                    ...
                    <!--<form role="form" action="home.php">-->
                        ...
                        <form action="userlog_loginchk.php" method="post" name="form_F" enctype="multipart/form-data" onSubmit="javascript: return valid();">
                        <input type="hidden" name="logintype_f" id="logintype_f" value="2">
