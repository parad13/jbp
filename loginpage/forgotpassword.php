...
<?php include("includes/head_links.php") ?>
	...
	<div class="container">
		<div class="full-content-center">
			<p class="text-center"><a href="#"><h2>Forgot Password</h2></a></p>
...
if(!empty($_REQUEST['submit'])) {
	...
	$selcountqry = mysqli_query($con,"select count(*) from users_m_t where user_email = '".$emailid."' and user_status = '1'");
	$result = mysqli_query($con,"select * from users_m_t where user_email = '".$emailid."' and user_status = '1'");
	while($selviewqry = mysqli_fetch_array($result)){
