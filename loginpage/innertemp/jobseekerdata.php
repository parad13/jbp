...
print "{";
$sub=mysqli_query($con,"SELECT * FROM subcourse_m_t WHERE courseID='".$rs['courseID']."' and subcourseStatus = 'E'");
$totsub = mysqli_query($con,$sub);
if($totsub > 0) {
	while($subsql=mysqli_fetch_array($sub))while($rs = mysqli_fetch_array($sql)){
	{
...
<?php */?>                      
        ...
        <option value="">Select</option>  
                ...
                $tophdrqry1 = mysqli_query($con,"select courseID , courseName from course_m_t
                                     where courseStatus = 'E'");
                while($data1 = mysqli_fetch_array($tophdrqry1)){
                	 ...
                	 <tr>
                      <td><p>Sub-Branch</p></td>
                       ...
                       <option value="">Select</option>
                         <?php
						// $subcourseID = '';
                $tophdrqry1 = mysqli_query($con,"select subcourseID , subcourseName from subcourse_m_t
