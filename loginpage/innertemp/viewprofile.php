...
<table width="100%" border="0">
    ...
    <tr>
        ...
        <td width="77%" ><input id="udob_f" class="" type="Text" readonly="" maxlength="1000" name="dob_f" value="<?php if(!empty($id )) { echo($dob); } ?>">&nbsp;<img style="cursor:pointer" onclick="javascript:NewCssCal('udob_f')" src="images2/cal.gif"></td>
        <td width="0%">&nbsp;</td>
    </tr>
    ...
    <tr>
        ...
        <td width="77%" style=""><strong><?php if(!empty($id )) { echo $userid; } ?></strong></td>
        <td width="0%">&nbsp;</td>
    </tr>
    ...
    <tr>
         ...
         <td align="left" style=""><strong><?php echo $oldpassword; ?></strong></td>
    </tr>
