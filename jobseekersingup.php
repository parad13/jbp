...
window.open("loginpage/userlog_loginchkjobskr.php?msg=Registered","_self");
}
</script>

<?php 
$your_email ='paraswaral@gmail.com';// <<=== update to your email address
...
if(isset($_POST['submit']))
{
	...
	if(empty($errors))
	{
		...
		echo "<script> location.replace('loginpage/userlog_loginchkjobskr.php'); </script>";
	}
}
...
?>
            <form name="form_F2" method="post" action="loginpage/userlog_loginchkjobskr.php" onSubmit="javascript: return valid2();" enctype="multipart/form-data">
