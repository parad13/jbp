...
//addOption(document.form_F.detcat_f, "0", ".........NONE.........", "");
	<?php
$sql= mysqli_query($con,"SELECT * FROM course_m_t where courseStatus = 'E'");
while($rs=mysqli_fetch_array($sql))
{ 
print "if(document.form_F.course_f.value == '".$rs['courseID']."')";
print "{";
$result=mysqli_query($con,"SELECT * FROM subcourse_m_t WHERE courseID='".$rs['subcourseID']."' and subcourseStatus = 'E'");
$totsub = mysqli_num_rows($result);
if($totsub > 0) {
	while($resultsql=mysqli_fetch_array($result))
	{
		print "addOption(document.form_F.subcourse_f,'".$resultsql['subcourseID']."', '".addslashes($resultsql['subcourseName'])."');";
	}
} else {
          ...
          <div class="span12" >
            <div class="wrap">
              <div class="main">
                ...
                <form name="form_F" method="post" action="#" onSubmit="javascript: return valid();" enctype="multipart/form-data">
...
padding-top:10px;
	...
	$searchqry 	   = mysqli_query($con,"select uploadImgPath
